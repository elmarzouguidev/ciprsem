...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="pull-left page-title">{{trans('admin.articles.trans_article')}}</h4>
                ...
                <div class="col-lg-4 article{{$article->id}}">
                    <div class="panel panel-border panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="{{URL::route('admin.article.trans.single',$article->id)}}" class="btn btn-primary m-t-15">
