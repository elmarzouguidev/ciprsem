<form name="form-article-edit" id="form-article-edit" class="form-horizontal" role="form" action="{{URL::route('admin.article.edit.save',$articles_edit->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <input type="text" name="title" id="title" class="form-control" value="{{$articles_edit->title_fr}}" style="direction: ltr">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            ...
            {{Form::textarea('body',$articles_edit->body_fr,['id'=>'body'])}}
