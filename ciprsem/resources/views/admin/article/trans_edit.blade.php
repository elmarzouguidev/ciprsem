            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form name="form-article-trans" id="form-article-trans" class="form-horizontal" role="form" action="{{URL::route('admin.article.trans.save',$articles_edit->id)}}" method="post" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="form-group ">
                                <hr>
                                <button type="submit" id="btn-save-article" class="btn btn-primary">{{trans('admin.articles.trans_article_enter_ok')}}</button>
                            </div>
...
@section('script_master')
    ...
    @include('admin.article.java.trans_java')
