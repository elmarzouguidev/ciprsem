                    ...
                    <div class="panel panel-default p-0 m-t-20">
                        <div class="panel-body p-0">
                            <div class="list-group mail-list">
                                ...
                                <a href="{{URL::route('admin.ciprsem.settings.videos')}}" class="list-group-item no-border">
                                    <i class="fa fa-star-o m-r-5"></i>
                    ...
                    <div class="col-md-8 col-lg-9">
                        ...
                        <div class="panel panel-default m-t-20">
                            <div class="panel-body p-t-30">
                                ...
                                <div class="fileupload fileupload-new" data-provides="fileupload" id="background_home">

                                    <div class="fileupload-preview thumbnail col-md-12 background_home">

                                        @if(!empty($background->home_background))

                                            <img src="{{asset('ciprsem/background'.'/'.$background->home_background)}}" alt="" />
                                        @else
                            ...
                            <div class="col-lg-12">
                                <div class="btn-toolbar" role="toolbar">
                                    <div class="pull-right">
                                        ...
                                        <a  class="delete_background btn btn-danger waves-effect waves-light m-r-5 {{$background->home_background ?'':'disabled'}} " data-id="{{$background->id}}" data-token="{{csrf_token()}}" >
...
@section('script_master')
    ...
    @include('admin.settings.java.home_background')
