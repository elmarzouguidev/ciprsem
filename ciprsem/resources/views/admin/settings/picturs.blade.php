                    ...
                    <div class="col-md-8 col-lg-9">
                        ...
                        <div class="panel panel-default m-t-20">
                            <div class="panel-body p-t-30">
                                ...
                                <div class="fileupload fileupload-new" data-provides="fileupload" id="picture_background">
                                    ...
                                    <div class="fileupload-preview thumbnail col-md-12" >
                                        ...
                                        @if(!empty($background->picturs_background))
                                            ...
                                            <img src="{{asset('ciprsem/background'.'/'.$background->picturs_background)}}" alt="" />
                                        @else
                            ...
                            <div class="col-lg-12">
                                <div class="btn-toolbar" role="toolbar">
                                    <div class="pull-right">
                                        ...
                                        <a  class="delete_background btn btn-danger waves-effect waves-light m-r-5 {{$background->picturs_background ?'':'disabled'}} " data-id="{{$background->id}}" data-token="{{csrf_token()}}" >
...
@section('script_master')
    ...
    @include('admin.settings.java.picturs_background')
