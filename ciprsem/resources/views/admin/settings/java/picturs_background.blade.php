<script>
    ...
    $('#add-background').on('submit',function(e){
        ...
        /* Abdelghafour ***/
        $.ajax({
            url: '{{URL::route('admin.ciprsem.store.picturs')}}',
            type: 'POST',
            data: form,
            processData: false,
            contentType: false,
            success:function(data) {
                ...
                else
                {
                    ...
                    setTimeout(function()
                        {
                            window.location = '{{URL::route('admin.ciprsem.settings.picturs')}}'
                        },
                        delay);
                        ...
                        $.ajax( {
                            ...
                            success: function (data) {
                                ...
                                if(data.success)
                                {
                                    ...
                                    $("#picture_background").load(location.href + " #picture_background");
                                }
                                else
                                {
