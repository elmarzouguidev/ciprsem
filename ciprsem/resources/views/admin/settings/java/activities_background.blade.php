<script>
    ...
    $('#add-background').on('submit',function(e){
        ...
        /* Abdelghafour ***/
        $.ajax({
            url: '{{URL::route('admin.ciprsem.store.activities')}}',
            type: 'POST',
            data: form,
            processData: false,
            contentType: false,
            success:function(data) {
                ...
                else
                {
                    ...
                    setTimeout(function()
                        {
                            window.location = '{{URL::route('admin.ciprsem.settings.activities')}}'
                        },
                        delay);
                        ...
                        $.ajax( {
                            ...
                            success: function (data) {
                                ...
                                if(data.success)
                                {
                                    ...
                                    $("#activities_background").load(location.href + " #activities_background");
                                }
                                else
                                {
